...
if(isset($_POST['reset']))
{
	...
	$email_id=$row['email'];
  	...
  	if($email==$email_id) {
	    $to = $email_id;
	    $txt = "Hi, ".$row['name'].". Click http://localhost:4040/ONLINE_ELECRTONIC_SHOP2/reset_password.php?email=$email to reset the password";
	    $subject = "Reset Password";
	    $msg=mail($to,$subject,$txt);
	    echo "$msg";
	    if($msg){
...
<div class="form-group">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="reset">RESET</button>
	</form>					
</div>
<!-- Sign-in -->
