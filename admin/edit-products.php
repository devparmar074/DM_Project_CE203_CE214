...
<input type="text"    name="productDescription"  placeholder="Enter Product Description" value="<?php echo htmlentities($row['productDescription']);?>" class="span8 tip" required>  
</div>
</div>
